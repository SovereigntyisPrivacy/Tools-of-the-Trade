...
export default function Settings() {
  ...
  const ALL_TOOLS = [
    { id: 'culinary', name: 'Culinary Engine' }, { id: 'fitness', name: 'Fitness Tracker' }, { id: 'survival', name: 'Survival Library' }, { id: 'chronos', name: 'Chronos Hub' }, { id: 'burner', name: 'Burner Pad' },
